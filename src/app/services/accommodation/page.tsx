...
export default function AccommodationPage() {
  const companies = partners.accommodation

  const benefits = [
    "Verified and secure properties",
    "Close to university campuses",
    "Furnished accommodations",
    "Flexible lease terms",
    "All-inclusive bills option",
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
              <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-xl bg-white/15 ring-1 ring-white/20 shrink-0">
                <Home className="h-6 w-6 sm:h-8 sm:w-8 text-white" strokeWidth={2} />
              </div>
            ...
            <p className="text-base sm:text-xl text-sunset-muted leading-relaxed">
              Find your home away from home. Browse verified student accommodations near your university with flexible terms.
            </p>
          </div>
        </div>
      </section>
      ...
      <PartnersSection
        ...
        servicePath="/services/accommodation"
      />

      <section className="py-6 sm:py-8">
        <div className="container mx-auto px-4">
          <div id="enquiry" className="max-w-2xl mx-auto scroll-mt-4">
            <EnquireForm serviceName="Student Accommodation" />
          </div>
        </div>
      </section>

      <Footer />
      <ChatBot currentService="Accommodation" />
    </div>
  )
}
