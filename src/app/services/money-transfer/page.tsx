...
export default function MoneyTransferPage() {
  const companies = partners.moneyTransfer
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
              <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-xl bg-white/15 ring-1 ring-white/20 shrink-0">
                <Banknote className="h-6 w-6 sm:h-8 sm:w-8 text-white" strokeWidth={2} />
              </div>
            ...
            <p className="text-base sm:text-xl text-sunset-muted leading-relaxed">
              Send money internationally with ease. Safe, secure, and affordable money transfer services for students.
            </p>
          </div>
        </div>
      </section>
      ...
      <PartnersSection
        ...
        servicePath="/services/money-transfer"
      />

      <section className="py-6 sm:py-8">
        <div className="container mx-auto px-4">
          <div id="enquiry" className="max-w-2xl mx-auto scroll-mt-4">
            <EnquireForm serviceName="Money Transfer" />
          </div>
        </div>
      </section>

      <Footer />
      <ChatBot currentService="Money Transfer" />
    </div>
  )
}
